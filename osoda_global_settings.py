...
def get_default_settings():
    ...
    settings["matchupDatasetTemplate"] = Template(path.join(settings["dataPathRoot"], "matchup_datasets/oceansoda-mmdb/", "OCEANSODA-MMDB-${YYYY}-fv01.nc")); #Location of the matchup dataset
    # settings["predictionDatasetsRoot"] = path.join(settings["dataPathRoot"], "prediction_datasets");
    settings["predictionDatasetsRoot"] = "K:\\downloaded";

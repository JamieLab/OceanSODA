...
def get_default_settings():
    ...
    settings["matchupDatasetTemplate"] = Template(path.join(settings["dataPathRoot"], "matchup_datasets/MDB v3.2plus/", "OCEANSODA-MMDB-${YYYY}-fv01.nc")); #Location of the matchup dataset

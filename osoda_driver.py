...
osoda_calculate_gridded_predictions.main(optAlgoTableBest, griddedTimeSeriesOutputPathBest, years, regions);

#Run for the 'long' (min 8 year time series) algorithms
...
osoda_calculate_gridded_predictions.main(optAlgoTableLong, griddedTimeSeriesOutputPathLong, years, regions);
...
#run for 'long'
carbonateParametersTemplateLong = settings["bestGriddedTimeSeriesPathTemplate"];
outputDirLong = path.join(settings["outputPathRoot"], "dic_outflow_amazon_best");

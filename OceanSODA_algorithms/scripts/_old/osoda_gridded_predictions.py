...
def create_gridded_timeseries_output_netCDF_file(outputPath, algorithmAT, RMSDeAT, sampleSizeAT, algorithmDIC, RMSDeDIC, sampleSizeDIC, latRes, lonRes, years, includeSeaCarbVariables=True):
    ...
    ncout.algorithmRMSDeAT = RMSDeAT;
    ncout.sampleSizeAT = sampleSizeAT;
    ncout.algorithmNameDIC = algorithmDIC.__class__.__name__;
    ncout.algorithmRMSDeDIC = RMSDeDIC;
    ncout.sampleSizeDIC = sampleSizeDIC;
    ...
    var.units = "PSU";
    var.long_name = "Uncertainty associated with the sea surface salinity used for prediction";
...
def calculate_gridded_timeseries_driver(outputPath, algorithmAT, RMSDeAT, sampleSizeAT, algorithmDIC, RMSDeDIC, sampleSizeDIC, years, inputDataPathInfo, latRes=1.0, lonRes=1.0, verbose=False):
    ...
    ncout = create_gridded_timeseries_output_netCDF_file(outputPath, algorithmAT, RMSDeAT, sampleSizeAT, algorithmDIC, RMSDeDIC, sampleSizeDIC, latRes, lonRes, years);

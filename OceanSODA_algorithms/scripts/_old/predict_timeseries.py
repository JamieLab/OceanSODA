...
ncOutputPathTemplate = Template(path.join("../output/gridded_predictions/gridded_${ALGO}_${LONRES}x${LATRES}.nc"));

#algorithms = osoda_global_settings.get_dic_algorithm_list() + osoda_global_settings.get_at_algorithm_list();
algorithms = [algorithms.dic_algorithms.Bakker1999_dic,
              algorithms.dic_algorithms.Gemayel2015_dic,
              algorithms.dic_algorithms.Hassoun2015_basins_dic,
              algorithms.dic_algorithms.Hassoun2015_full_dic,
              algorithms.dic_algorithms.Lefevre2010_dic,
              algorithms.dic_algorithms.Lefevre2017_dic,
              algorithms.dic_algorithms.Lee2000_dic,
              ];
years = range(2010, 2018);


for AlgorithmFunctor in algorithms:
    #Create instance of the algorithm
    algorithm = AlgorithmFunctor(settings);
    
    ###########################################
    # Create an output netCDF file to write to
    outputPath = ncOutputPathTemplate.safe_substitute(ALGO=type(algorithm).__name__, LATRES=latRes, LONRES=lonRes);
